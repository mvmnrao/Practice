...
using Manik.Practice.Sessions;
using Manik.Practice.Web.Models;
using Manik.Practice.Web.Models.Layout;

namespace Manik.Practice.Web.Controllers
{
    public class LayoutController : PracticeControllerBase
    {
